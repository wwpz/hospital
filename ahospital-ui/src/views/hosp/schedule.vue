...
export default {
  ...
  methods: {
    ...
    getDetailSchedule() {
      ...
      hosp.getScheduleDetail(params)
        .then(response => {
          this.scheduleList = response.object
        })
    },
    ...
    getScheduleRule() {
      ...
      hosp.getScheduleRule(params).then(response => {
        this.bookingScheduleList = response.object.bookingScheduleRuleList
        this.total = response.object.total
        this.scheduleList = response.object.scheduleList
        this.baseMap = response.object.baseMap
